...
{
    SSP1ADD =  0b01001111;		// Fclock = 100kHz, 32MHz Fosc, BRG = 79 - pg280
    SSP1STAT = 0b00000000;              // SMP: input sampled at middle of data,
...
{
    TXSTA = 0b00100100;                 // 8-bit Tx, Enable Tx, Async mode, BRGH = High speed - pg296
    ...
    SPBRG = 68;                         // 115.2k baud rate, 32MHz, 0.64% error - pg303
}   // end of UART_config
