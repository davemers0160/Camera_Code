...
#if defined(_WIN32) | defined(__WIN32__) | defined(__WIN32) | defined(_WIN64) | defined(__WIN64)
	//thread Focus_Thread, Defocus_Thread;
#else
...
#if defined(_WIN32) | defined(__WIN32__) | defined(__WIN32) | defined(_WIN64) | defined(__WIN64)
		//thread Focus_Thread(saveVideo_t, videoSaveFocus);
		saveVideo_t(videoSaveFocus);
#else		
...
#if defined(_WIN32) | defined(__WIN32__) | defined(__WIN32) | defined(_WIN64) | defined(__WIN64)
		//thread Defocus_Thread(saveVideo_t, videoSaveDefocus);
		saveVideo_t(videoSaveDefocus);
#else
